...
public class Util {
	...
	public static class Pose2dTimeInterpolable {
		...
		public Pose2d getPoseFromTime(Time time) {
			...
			// SmartDashboard.putNumber("Auto Align Traj/Percent As Delta", percentIntoDelta);
	...
	public static double calculateDistanceToStartDeccel(
		...
		// return (currentVel * currentVel) / (2.0 * stowedAccel) + ((timeToRaise * timeToRaise * raisedAccel * 0.5) *
