...
public final class SuperstructureConstants {
		...
		public static BeamBreakIO getCoralClose() {
			if (Robot.isReal()) {
				return new BeamBreakIOSim(
						...
						< Units.Meters.of(2.5).baseUnitMagnitude(),
	...
	public static final Distance kProcessorAlgaeScoringDistanceEpsilon = Units.Centimeters.of(12.0); // TODO Tune THIS!!
	...
	public static final Angle kProcessorAlgaeScoringAngleEpsilon = Units.Degrees.of(3.0); // TODO TUNE THIS !!!
