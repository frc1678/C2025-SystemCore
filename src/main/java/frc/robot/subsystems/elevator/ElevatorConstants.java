...
public class ElevatorConstants {
	...
	public static final Distance kL2ScoringHeight = Units.Inches.of(5.7);
	...
	public static final Distance kL4PivotClearHeight = kL4ScoringHeight.minus(Units.Inches.of(13d));
	...
	public static final TalonFXConfiguration getFXConfig() {
		...
		FXConfig.Slot0.kP = 16.3; // Position
		FXConfig.Slot0.kD = 0.5; // Derivative
		FXConfig.Slot0.kS = 0.45; // Feedforwards
		FXConfig.Slot0.kG = 0.35; // Gravity
	...
	public static ServoHomingConfig getServoConfig() {
		...
		servoConfig.kHomingVoltage = Units.Volts.of(-0.5); // includes direction
