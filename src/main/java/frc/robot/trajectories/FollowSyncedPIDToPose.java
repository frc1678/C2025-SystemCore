...
public class FollowSyncedPIDToPose extends PIDToPoseCommand {
	...
	public void execute() {
		...
		// SmartDashboard.putBoolean("Auto Align PID/Synced Info/Close Enough For Elevator",
		// closeEnoughToRaiseElevator);
		// SmartDashboard.putBoolean("Auto Align PID/Synced Info/Should Start Slowing", shouldStartSlowing);
		// SmartDashboard.putBoolean("Auto Align PID/Synced Info/Slow Enough To Raise", slowEnoughToRaiseElevator);

		// SmartDashboard.putNumber(
		// 		"Auto Align PID/Synced Info/Distance To Start Slowing",
		// 		DriveConstants.distanceToStartSlowingL4.in(Units.Meters));
		// SmartDashboard.putNumber(
		// 		"Auto Align PID/Synced Info/Raise Distance", DriveConstants.distanceToRaiseElevatorL4.in(Units.Meters));
	}
