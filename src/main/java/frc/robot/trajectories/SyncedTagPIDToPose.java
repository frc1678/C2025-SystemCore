...
public class SyncedTagPIDToPose extends FollowSyncedPIDToPose {
	public SyncedTagPIDToPose(Pose2d finalPose, Level level) {
		super(finalPose, level);
	}

	public SyncedTagPIDToPose(Pose2d rawEndPose, Level level, boolean diffParam) {
