...
public class MotionPlanner {
		...
		Supplier<Command> supplier = () -> {
			...
			if (currentSetpoint.mode.isPositionControl()
				...
				return Commands.sequence(
						...
						// Commands.waitUntil(canUnclearWhen),
						// Elevator.mInstance.setpointCommand(currentSetpoint)
						);
			}
		};
		...
		Supplier<Command> supplier = () -> {
			...
			if (currentSetpoint.mode.isPositionControl()
				...
				return Commands.sequence(
						...
						// Commands.waitUntil(canUnclearWhen),
						// CoralDeploy.mInstance.setpointCommand(currentSetpoint)
						);
			}
		};
	...
	public static class UnsafePivotAndElevatorSynchronousToPositionMotionMagic extends Command {
		...
		public void execute() {
			...
			// SmartDashboard.putNumber("SynchronousPivotElevator/elevatorFracIn", elevatorFractionIn);
			// SmartDashboard.putNumber("SynchronousPivotElevator/pivotFracIn", pivotFractionIn);
			// SmartDashboard.putNumber("SynchronousPivotElevator/currentPivotBaseUnits", currentPivotBaseUnits);
			// SmartDashboard.putNumber("SynchronousPivotElevator/currentElevatorBaseUnits", currentElevatorBaseUnits);
			// SmartDashboard.putNumber("SynchronousPivotElevator/targetPivotBaseUnits", pivotSetpointBaseUnits);
			// SmartDashboard.putNumber("SynchronousPivotElevator/targetElevatorBaseUnits", elevatorSetpointBaseUnits);
		}
