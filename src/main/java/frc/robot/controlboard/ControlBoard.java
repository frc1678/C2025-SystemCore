...
public class ControlBoard extends SubsystemBase {
	...
	public void driverControls() {
		...
		// overrideTrigger
		// 		.and(() -> getCoralMode())
		// 		.and(() -> Superstructure.mInstance.getState() == Superstructure.State.L1_CORAL)
		// 		.onTrue(s.softCoralScore())
		// 		.onFalse(s.tuck());
		...
		// 		.and(() -> getCoralMode())
		// 		.onTrue(s.L1Prep()
		// 				.beforeStarting(s.waitToStartScoreSequence())
		// 				.withInterruptBehavior(InterruptionBehavior.kCancelIncoming)
		// 				.onlyWhile(driver.povRight()))
		// 		.onTrue(setOverrideBehavior(OverrideBehavior.CORAL_SCORE_L1))

		// 		.onTrue(
		// 			Superstructure.mInstance
		// 			.goToScoringPose(Level.L1)
		// 			.asProxy()
